...
npf.debug.ErrorReporter = function(handlerUrl, opt_contextProvider,
    opt_noAutoProtect) {
  npf.debug.ErrorReporter.base(
    this, 'constructor', handlerUrl, opt_contextProvider, opt_noAutoProtect);
};
...
npf.debug.ErrorReporter.prototype.handleException = function(e, opt_context) {
  ...
  npf.debug.ErrorReporter.base(this, 'handleException', e, opt_context);
};
