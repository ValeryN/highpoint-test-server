...
npf.ui.PagePaginator = function(pageCount, opt_page, opt_renderer,
    opt_domHelper) {
  npf.ui.PagePaginator.base(
    this,
    'constructor',
    opt_renderer || npf.ui.pagePaginator.Renderer.getInstance(),
    opt_domHelper);
...
npf.ui.PagePaginator.prototype.enterDocument = function() {
  ...
  if (prevElement) {
    this.getHandler().
      listen(prevElement, goog.events.EventType.CLICK, this.onPrevClick_);
  }

  if (nextElement) {
    this.getHandler().
      listen(nextElement, goog.events.EventType.CLICK, this.onNextClick_);
  }
