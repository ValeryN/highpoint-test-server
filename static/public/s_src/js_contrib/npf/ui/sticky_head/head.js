 ...
 * @param {npf.ui.stickyHead.HeadRenderer=} opt_renderer
 * @param {goog.dom.DomHelper=} opt_domHelper
 * @constructor
 * @extends {npf.ui.RenderedComponent}
 */
npf.ui.stickyHead.Head = function(sticky, opt_renderer, opt_domHelper) {
	npf.ui.stickyHead.Head.base(
		this,
		'constructor',
		opt_renderer || npf.ui.stickyHead.HeadRenderer.getInstance(),
		opt_domHelper);
...
npf.ui.stickyHead.Head.prototype.enterDocument = function() {
	npf.ui.stickyHead.Head.base(this, 'enterDocument');
