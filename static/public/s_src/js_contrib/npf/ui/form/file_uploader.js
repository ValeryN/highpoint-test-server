...
npf.ui.form.FileUploader = function(name, opt_renderer, opt_domHelper) {
  npf.ui.form.FileUploader.base(
    ...
    'constructor',
    name,
    opt_renderer || npf.ui.form.FileUploaderRenderer.getInstance(),
    opt_domHelper);
...
npf.ui.form.FileUploader.prototype.exitDocument = function() {
  ...
  if (this.dropArea_) {
    this.dropArea_.setVisible(false);
    goog.Timer.clear(this.dropAreaHideTimeoutId_);
  }
...
/** @inheritDoc */
scd.ui.form.Gender.prototype.setValue = function(value, opt_noRender,
    opt_force) {
...
npf.ui.form.FileUploader.prototype.onDragLeave = function(evt) {
  if (this.dropArea_) {
    this.dropAreaHideTimeoutId_ = goog.Timer.callOnce(function() {
      this.dropArea_.setVisible(false);
    }, 100, this);
  }
};
