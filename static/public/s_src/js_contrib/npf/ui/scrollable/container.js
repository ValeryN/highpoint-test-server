...
npf.ui.scrollable.Container = function(opt_renderer, opt_domHelper) {
  npf.ui.scrollable.Container.base(
    this,
    'constructor',
    opt_renderer || npf.ui.scrollable.ContainerRenderer.getInstance(),
    opt_domHelper);
...
/**
 * @param {number} x
 * @deprecated Use npf.ui.scrollable.Container.prototype.setScrollLeft.
 */
npf.ui.scrollable.Container.prototype.animateToLeft = function(x) {
  this.animate(x, this.scrollTop_);
};

/**
 * @param {number} y
 * @deprecated Use npf.ui.scrollable.Container.prototype.setScrollTop.
 */
npf.ui.scrollable.Container.prototype.animateToTop = function(y) {
  this.animate(this.scrollLeft_, y);
};

/**
 * @param {number|goog.math.Coordinate} x
 * @param {number=} opt_y
 * @deprecated Use npf.ui.scrollable.Container.prototype.setScrollPosition.
 */
npf.ui.scrollable.Container.prototype.animate = function(x, opt_y) {
  this.setScrollPosition(x, opt_y, false, true);
};
...
/**
 * @return {boolean}
 * @deprecated Use npf.ui.scrollable.Container.prototype.isAutoContentSize.
 */
npf.ui.scrollable.Container.prototype.isContentSizeFromElement = function() {
  return this.isAutoContentSize();
};

/**
 * @param {boolean} autoSize
 * @deprecated Use npf.ui.scrollable.Container.prototype.setAutoContentSize.
 */
npf.ui.scrollable.Container.prototype.setContentSizeFromElement = function(
    autoSize) {
  this.setAutoContentSize(autoSize);
};
...
/**
 * @return {boolean}
 * @deprecated Use npf.ui.scrollable.Container.prototype.isAutoSize
 */
...
/**
 * @param {boolean} autoSize
 * @deprecated Use npf.ui.scrollable.Container.prototype.setAutoSize.
 */
