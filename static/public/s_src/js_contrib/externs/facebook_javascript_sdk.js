 ...
 * @param {boolean=} onOrOff Whether to turn the timer on or off. truthy == on, falsy == off. default is true
 * @param {number=} interval How often to resize (in ms). default is 100ms
 */
...
FB.Auth.setAuthResponse = function() {};
